...
const CareerForm = () => {
  ...
  const [chooseData, setChooseData] = useState(""); // This tracks 'job' or 'internship'
  const [finalData, setFinalData] = useState([]); // This stores the list of titles

  useEffect(() => {
    // FIX 1: Use toLowerCase() as a function
    // FIX 2: Correct logic for filtering titles
  ...
  return (
    <div className="w-full min-h-screen bg-[#102a43] flex items-center justify-center p-6 lg:p-16">
