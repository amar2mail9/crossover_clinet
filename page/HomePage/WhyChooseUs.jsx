...
const WhyChooseUs = () => {
  return (
    <section className="relative w-full bg-slate-50 py-16 md:py-24 overflow-hidden selection:bg-[#FE741F] selection:text-white">
      {/* ===== Background Graphics ===== */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 items-start">
        ...
        <div className="w-full lg:col-span-5 lg:sticky lg:top-32 space-y-10">
          <div className="space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#0F2B46] tracking-tight leading-tight">
              Built for <br className="hidden md:block lg:hidden" />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FE741F] to-[#ff9b5e]">
                Reliability
              </span>
            </h1>

            <p className="text-gray-600 text-lg md:text-xl leading-relaxed max-w-lg">
              We support businesses with secure customer operations, smart
              capital solutions, and scalable technology services designed for
              long-term growth.
            </p>
          </div>
        ...
        <div className="w-full lg:col-span-7 flex flex-col gap-14 lg:pt-16">
          {WhyChooseData.map((card) => (
            <div
              ...
              className="bg-[#0F2B46] hover:bg-[#FE741F] w-full max-w-[500px] h-[140px] shadow-2xl rounded-2xl py-4 px-6 relative transition-all duration-500 group mx-auto lg:ml-auto lg:mr-0"
            >
              {/* Floating Icon */}
